    ...
    <td width="182" valign="top"><div id="container">
      ...
      <div class="content">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
         ...
         <ul class="MM">
          <li><a href="#" onclick="javascript:doit('/lockMgr.do?method=queryLockInfo');">被锁的对象</a></li>
          <li><a href="#" onclick="javascript:doit('/storeMgr.do?method=queryOverXExtentsInfo');">储存空间过大的区/块</a></li>
          <li><a href="#" target="I2">大表及分区表</a></li>
          <li><a href="#" target="I2">失效的对象</a></li>
          <li><a href="#" target="I2">热点块</a></li>
        </ul>
      </div>
