...
<body>
<form method="post" action="<%=path%>/usualMgr.do?method=queryPropsSessionInfo">
<div id="center-column">
			...
			<TABLE width=72% border=0 cellPadding=0 cellSpacing=0 id=secTable>
                <TBODY>
                  <TR align=middle height=20>
                    <TD align="center" onclick=secBoard(0) >server端字符集信息</TD>
                    <TD align="center" onclick=secBoard(1) >client端字符集信息</TD>
                    <TD align="center" onclick=secBoard(2) style="background-color:#F7EFF1;">session字符集信息</TD>
                  </TR>
                </TBODY>
              </TABLE>
		  </div>
		  ...
		  <br /><HR style="FILTER: alpha(opacity=100,finishopacity=0,style=1)" width="80%" color=#987cb9 SIZE=3>
			<b>session字符集信息列表:</b><div class="table">
