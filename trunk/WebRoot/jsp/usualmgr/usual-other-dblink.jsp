...
<body>
<form method="post" action="<%=path%>/usualMgr.do?method=queryDBLinkInfo">
			...
			<TABLE width=72% border=0 cellPadding=0 cellSpacing=0 id=secTable>
                <TBODY>
                  <TR align=middle height=20>
                    ...
                    <TD align="center" onclick=secBoard(3) style="background-color:#F7EFF1;">DBLINK信息</TD>
                  </TR>
                </TBODY>
              </TABLE>
		  </div>
		  <br /><HR style="FILTER: alpha(opacity=100,finishopacity=0,style=1)" width="80%" color=#987cb9 SIZE=3>
			<b>DBLINK信息:</b><div class="table">
