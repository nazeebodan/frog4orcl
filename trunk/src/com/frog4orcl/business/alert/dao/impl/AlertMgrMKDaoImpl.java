 ...
 * 
 */
package com.frog4orcl.business.alert.dao.impl;
 ...
 * @create: Feb 11, 2011 3:57:58 PM
 * @version: 1.0
 */
public class AlertMgrMKDaoImpl implements AlertMgrMKDao {
	private static Logger logger = Logger.getLogger(AlertMgrMKDaoImpl.class);
