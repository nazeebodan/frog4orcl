...
<body>
<form method="post" action="<%=path%>/usualMgr.do?method=querySchedulerJobsInfo">
			...
			<TABLE width=72% border=0 cellPadding=0 cellSpacing=0 id=secTable>
                <TBODY>
                  <TR align=middle height=20>
                    ...
                    <TD align="center" onclick=secBoard(2) style="background-color:#F7EFF1;">Scheduler下的job信息</TD>
