...
<body>
<form method="post" action="<%=path%>/storeMgr.do?method=queryOverXBlocksInfo">
<div id="center-column">
		...
		<div class="select-bar">
			...
			<TABLE width=72% border=0 cellPadding=0 cellSpacing=0 id=secTable>
                <TBODY>
                  <TR align=middle height=20>
                    <TD align="center" onclick=secBoard(0) >存储空间过大的区的对象</TD>
                    <TD align="center" onclick=secBoard(1) style="background-color:#F7EFF1;">存储空间过大的块的对象</TD>
                  </TR>
                </TBODY>
              </TABLE>
		  </div>
		 <div class="select-bar">
		    <label>
		    <span class="breadcrumbs">块大小(默认为):
			...
			<b>存储空间过大的块的对象:</b> <div class="table">
